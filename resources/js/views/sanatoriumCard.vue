...
<!--                  <template v-for="image in post.image_post">-->
                  <img :src="post.sanatorium_preview_image">
<!--                  </template>-->
                  ...
                  <template v-else-if="Number(post.berth) != 1">
                    <label :id="`${post.category}`">{{post.category}}<br>({{post.berth}} спальных мест)</label>
                  </template>
                  <ul>
            ...
            <div class="col col-12 col-md-6">
              ...
              <div class="reviews">
                ...
                <div :class="state.user !== '' ? '' : 'hide'">
                  ...
                  <p><input class="comment-button" @click.prevent="commentSanatorium" type="submit" value="Отправить"></p>
                </div>
              </div>
            </div>
          </div>
