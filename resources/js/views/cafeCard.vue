                  ...
                  <div v-for="list in lists" class="category fadeInUp wow animated"
                    ...
                    <div v-for="subcat in items" class="subcategory">
                      <div class="d-flex col justify-content-between">
                        <div><label
                            v-if="subcat.cafe_todo_list_id === list.id && list.user_id === card.user_id && subcat.deleted_at === null">{{subcat.title}}</label></div>
                        <div><label
                            v-if="subcat.cafe_todo_list_id === list.id && list.user_id === card.user_id && subcat.deleted_at === null">{{subcat.price}}</label></div>
                      </div>

                      <div v-for="product in products" class="service">
                        <div class="d-flex col justify-content-between" v-if="product.cafe_todo_item_id === subcat.id && subcat.cafe_todo_list_id === list.id && list.user_id === card.user_id && product.deleted_at === null ">
                          <p>{{product.title}}</p>
                          <p>{{product.price}}</p>
                        </div>
                      </div>
