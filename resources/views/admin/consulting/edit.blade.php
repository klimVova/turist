...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{route('admin.consulting.update', $user->id)}}" method="POST" class="w-25">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group w-100">
                            ...
                            <select class="select2" name="consultingCats_ids[]" multiple="multiple"
                                ...
                                @foreach($consultingCats as $consultingCat)
                                    <option
                                        {{is_array( $user->cats->pluck('id')->toArray()) && in_array($consultingCat->id, $user->cats->pluck('id')->toArray()) ? ' selected' : ''}}
                                        value="{{$consultingCat->id}}">{{$consultingCat->title}}
                                    </option>
                                @endforeach
                            </select>
                        </div>
