...
@section('content')
    ...
    <div class="ml-3" >
            ...
            @foreach($images as $image)
                <div class="col-12 col-md-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <form action="{{route('admin.post.image_remove', $image->id )}}" method="post">
                            @csrf
                            @method('DELETE')
        ...
        <div class="form-group w-50 ml-4">
            <form action="{{route('admin.post.image_store', $post->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
