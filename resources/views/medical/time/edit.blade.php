...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{route('medical.time.update', $medicalTime->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="form-group w-25">
                            <input type="text" class="form-control" name="time_start" placeholder="Начало работы центра"
                                   value="{{$medicalTime->time_start}}">
                            @error('time_start')
