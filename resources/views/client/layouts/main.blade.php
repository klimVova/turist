...
<script  src="{{asset('assets/md/js/jquery.js')}}"></script>
<script  src="{{asset('assets/md/js/popper.js')}}"></script>
<script  src="{{asset('assets/md/js/bootstrap.js')}}"></script>
<script  src="{{asset('assets/md/js/mdb.min.js')}}"></script>
