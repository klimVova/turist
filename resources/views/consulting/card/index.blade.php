    ...
    <div class="content-wrapper">
        ...
        <div class="info ml-3">
                                ...
                                @foreach($consultingPosts as $consultingPost)
                                    <tr>
                                        ...
                                        <td><img class="img-thumbnail" style="height: 10vh;"
                                                             src="{{ url('storage/' . $consultingPost->preview_image)}}" alt="preview_image"></td>
            ...
            <div class="services">
                ...
                <div class="w-50">
                    <form action="{{route('consulting.todolist.store'), $id}}" method="POST" class="w-55">
                        ...
                        <div class="input-group">
                            ...
                            @if(count($consulting_todo_lists) >= 5)
                    ...
                    <div class="mt-3">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-sm-center"><a href="{{route('consulting.todolist.edit', $consulting_todo_list->id)}}"
                                                           class='text-success mr-3'><i class="fas fa-pencil-alt"></i></a>
                                    <form action="{{route('consulting.todolist.delete', $consulting_todo_list->id)}}"
                                          method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="border-0 bg-transparent" l>
                ...
                <h1>Услуги</h1>
                <div class="w-50">
                    <form action="{{route('consulting.service.store')}}" method="POST" class="w-55">
                        @csrf
                        <div class="input-group">
                            <input type="text" name="title" class="form-control"
                        ...
                        <table class="table">
                            ...
                            @foreach($services as $service)
                                <tr>
                                    <td> {{$service->title}}</td>
                                    <td> {{$service->price}}</td>
                                    <td class="d-flex justify-content-sm-center"><a href="{{route('consulting.service.edit', $service->id)}}"
                                                                                    class='text-success mr-3'><i class="fas fa-pencil-alt"></i></a>
                                        <form action="{{route('consulting.service.delete', $service->id)}}"
                                              method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="border-0 bg-transparent" l>
